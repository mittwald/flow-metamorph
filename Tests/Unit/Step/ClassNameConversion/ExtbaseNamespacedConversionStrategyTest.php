...
class ExtbaseNamespacedConversionStrategyTest extends UnitTestCase {
	...
	/** @var \Mw\Metamorph\Step\ClassNameConversion\ExtbaseNamespacedConversionStrategy */
	private $strategy;

	public function setUp() {
		$this->strategy = new \Mw\Metamorph\Step\ClassNameConversion\ExtbaseNamespacedConversionStrategy();
	}
