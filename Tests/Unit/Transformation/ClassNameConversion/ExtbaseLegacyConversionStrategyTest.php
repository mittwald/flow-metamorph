...
use Mw\Metamorph\Transformation\ClassNameConversion\ExtbaseLegacyConversionStrategy;
use TYPO3\Flow\Tests\UnitTestCase;

class ExtbaseLegacyConversionStrategyTest extends UnitTestCase {

	/** @var ExtbaseLegacyConversionStrategy */
	private $strategy;

	public function setUp() {
		$this->strategy = new ExtbaseLegacyConversionStrategy();
	}
